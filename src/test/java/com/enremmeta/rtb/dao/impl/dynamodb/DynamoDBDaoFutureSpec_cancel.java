...
public class DynamoDBDaoFutureSpec_cancel {
    ...
    public void returnsExpectedValue() {
        ...
        Mockito.when(futureMock.cancel(false)).thenReturn(expectedResult);
        //dynamoDBDaoFuture = new DynamoDBDaoFuture<String>(dynamoDBService, futureMock, "Key");
        
        //boolean result = dynamoDBDaoFuture.cancel(false);
        
        Mockito.verify(futureMock).cancel(false);
    ...
    public void returnsFalseForKnownFuture() {
        ...
        //boolean result = dynamoDBDaoFuture.cancel(true);

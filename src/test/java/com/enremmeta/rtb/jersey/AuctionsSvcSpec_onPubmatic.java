...
public class AuctionsSvcSpec_onPubmatic {
    ...
    public void setUp() throws Throwable {
        ...
        pmAdapterMock = PowerMockito.mock(PubmaticAdapter.class);
        Mockito.when(pmAdapterMock.convertRequest(any(OpenRtbRequest.class))).thenCallRealMethod();

        PowerMockito.whenNew(PubmaticAdapter.class).withNoArguments().thenReturn(pmAdapterMock);
    ...
    @Test
    public void positiveFlow_shouldConfiurePubmaticAdapterAndCallOnBidRequestDelegate()
                    throws Throwable {


        svc.onPubmatic(Mockito.mock(AsyncResponse.class), Mockito.mock(UriInfo.class),
                        new OpenRtbRequest(), "xff", Mockito.mock(HttpServletRequest.class), "xrip",
                        "debug");

        // verify adapter constructor call
        PowerMockito.verifyNew(PubmaticAdapter.class).withNoArguments();

        // verify adapter call to convertRequest
        Mockito.verify(pmAdapterMock, times(1)).convertRequest(any(OpenRtbRequest.class));
    ...
    public void negativeFlow_shouldLogBrockenRequest() throws Exception {
        ...
        svc.onPubmatic(Mockito.mock(AsyncResponse.class), Mockito.mock(UriInfo.class), badReq,
        ...
        // verify exception
        PowerMockito.verifyStatic(Mockito.times(1));
        LogUtils.error(Mockito.eq("Error parsing request from Pubmatic: null"),

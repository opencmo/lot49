...
public interface AmazonDynamoDB {
     ...
     * <p>
     * Callers can pass in just the endpoint (ex: "dynamodb.us-east-1.amazonaws.com") or a full URL,
     * including the protocol (ex: "https://dynamodb.us-east-1.amazonaws.com"). If the protocol is
     ...
     * <p>
     * For more information on using AWS regions with the AWS SDK for Java, and a complete list of
     * all available endpoints for all AWS services, see:
     * <a href= "http://developer.amazonwebservices.com/connect/entry.jspa?externalID=3912" > http:/
     * /developer.amazonwebservices.com/connect/entry.jspa?externalID= 3912</a>
     * <p>
     * <b>This method is not threadsafe. An endpoint should be configured when the client is created
     ...
     *
     * @param endpoint
     *            The endpoint (ex: "dynamodb.us-east-1.amazonaws.com") or a full URL, including the
     *            protocol (ex: "https://dynamodb.us-east-1.amazonaws.com") of the region specific
     *            AWS endpoint this client will communicate with.
     */
    void setEndpoint(String endpoint);

    /**
     * An alternative to {@link AmazonDynamoDB#setEndpoint(String)}, sets the regional endpoint for
     * this client's service calls. Callers can use this method to control which AWS region they
     * want to work with.
     * <p>
     * By default, all service endpoints in all regions use the https protocol. To use http instead,
     * specify it in the {@link com.amazonaws.ClientConfiguration} supplied at construction.
     * <p>
     ...
     *            accessing a given region. Must not be null and must be a region where the service
     *            is available.
     *
     ...
     *
     * @see #batchGetItem(com.amazonaws.services.dynamodbv2.model.BatchGetItemRequest)
     */
    Future<BatchGetItemResult> batchGetItem(Map<String, KeysAndAttributes> requestItems,
     ...
     *
     * @see #batchWriteItem(com.amazonaws.services.dynamodbv2.model.BatchWriteItemRequest)
     */
    Future<BatchWriteItemResult> batchWriteItem(
                    Map<String, java.util.List<WriteRequest>> requestItems);
     ...
     *
     * @see #createTable(com.amazonaws.services.dynamodbv2.model.CreateTableRequest)
     */
    Future<CreateTableResult> createTable(java.util.List<AttributeDefinition> attributeDefinitions,
     ...
     *
     * @see #deleteItem(com.amazonaws.services.dynamodbv2.model.DeleteItemRequest)
     */
    Future<DeleteItemResult> deleteItem(String tableName, Map<String, AttributeValue> key);
     ...
     *
     * @see #deleteTable(com.amazonaws.services.dynamodbv2.model.DeleteTableRequest)
     */
    Future<DeleteTableResult> deleteTable(String tableName);
     ...
     */
    Future<DescribeLimitsResult> describeLimits(DescribeLimitsRequest describeLimitsRequest);
     ...
     *
     * @see #describeTable(com.amazonaws.services.dynamodbv2.model.DescribeTableRequest)
     */
    Future<DescribeTableResult> describeTable(String tableName);
     ...
     *
     * @see #getItem(com.amazonaws.services.dynamodbv2.model.GetItemRequest)
     */
    Future<GetItemResult> getItem(String tableName, Map<String, AttributeValue> key);
     ...
     *
     * @see #listTables(com.amazonaws.services.dynamodbv2.model.ListTablesRequest)
     */
     ...
     * @see #listTables(com.amazonaws.services.dynamodbv2.model.ListTablesRequest)
     */
    Future<ListTablesResult> listTables(String exclusiveStartTableName);
     ...
     * @see #listTables(com.amazonaws.services.dynamodbv2.model.ListTablesRequest)
     */
    Future<ListTablesResult> listTables(String exclusiveStartTableName, Integer limit);
     ...
     * @see #listTables(com.amazonaws.services.dynamodbv2.model.ListTablesRequest)
     */
    Future<ListTablesResult> listTables(Integer limit);
     ...
     *
     * @see #putItem(com.amazonaws.services.dynamodbv2.model.PutItemRequest)
     */
    Future<PutItemResult> putItem(String tableName, Map<String, AttributeValue> item);
     ...
     *
     * @see #scan(com.amazonaws.services.dynamodbv2.model.ScanRequest)
     */
    Future<ScanResult> scan(String tableName, java.util.List<String> attributesToGet);
     ...
     * @see #scan(com.amazonaws.services.dynamodbv2.model.ScanRequest)
     */
    Future<ScanResult> scan(String tableName, Map<String, Condition> scanFilter);
     ...
     *
     * @see #updateItem(com.amazonaws.services.dynamodbv2.model.UpdateItemRequest)
     */
    Future<UpdateItemResult> updateItem(String tableName, Map<String, AttributeValue> key,
     ...
     *
     * @see #updateTable(com.amazonaws.services.dynamodbv2.model.UpdateTableRequest)
     */
    Future<UpdateTableResult> updateTable(String tableName,
                    ProvisionedThroughput provisionedThroughput);
     ...
     * it as soon as possible after executing a request.
     *
     * @param request

package com.amazonaws.services.dynamodbv2.nio;
...
import com.amazonaws.services.dynamodbv2.nio.http.ExecutionContext;
 ...
 * Created by amiroshn
 *
 * Client for accessing DynamoDB. All service calls made using this client are blocking, and will
 * not return until the service call completes.
 * <p>
 * <fullname>Amazon DynamoDB</fullname>
 * <p>
 * This is the Amazon DynamoDB API Reference. This guide provides descriptions of the low-level
 * DynamoDB API.
 * </p>
 * <p>
 ...
 * <li>
 * <p>
 * <a href= "http://docs.aws.amazon.com/amazondynamodb/latest/gettingstartedguide/" >Amazon DynamoDB
 * Getting Started Guide</a> - provides hands-on exercises that help you learn the basics of working
 * with DynamoDB. <i>If you are new to DynamoDB, we recommend that you begin with the Getting
 * Started Guide.</i>
 * </p>
 * </li>
 * <li>
 * <p>
 * <a href="http://docs.aws.amazon.com/amazondynamodb/latest/developerguide/"> Amazon DynamoDB
 * Developer Guide</a> - contains detailed information about DynamoDB concepts, usage, and best
 * practices.
 * </p>
 * </li>
 * <li>
 * <p>
 * <a href="http://docs.aws.amazon.com/dynamodbstreams/latest/APIReference/"> Amazon DynamoDB
 * Streams API Reference</a> - provides descriptions and samples of the DynamoDB Streams API. (For
 * more information, see
 * <a href= "http://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Streams.html" >
 * Capturing Table Activity with DynamoDB Streams</a> in the Amazon DynamoDB Developer Guide.)
 * </p>
 * </li>
 * </ul>
 * <p>
 * Instead of making the requests to the low-level DynamoDB API directly from your application, we
 * recommend that you use the AWS Software Development Kits (SDKs). The easy-to-use libraries in the
 * AWS SDKs make it unnecessary to call the low-level DynamoDB API directly from your application.
 * The libraries take care of request authentication, serialization, and connection management. For
 * more information, see
 * <a href= "http://docs.aws.amazon.com/amazondynamodb/latest/developerguide/UsingAWSSDK.html" >
 ...
 * necessary code to authenticate your requests. For more information on signing your requests, see
 * <a href= "http://docs.aws.amazon.com/amazondynamodb/latest/developerguide/API.html" >Using the
 ...
 * <li>
 * <p>
 * <i>CreateTable</i> - Creates a table with user-specified provisioned throughput settings. You
 * must define a primary key for the table - either a simple primary key (partition key), or a
 * composite primary key (partition key and sort key). Optionally, you can create one or more
 ...
 * <li>
 * <p>
 * <i>UpdateTable</i> - Modifies the provisioned throughput settings for a table. Optionally, you
 * can modify the provisioned throughput settings for global secondary indexes on the table.
 * </p>
 * </li>
 * <li>
 * <p>
 ...
 * <a href= "http://docs.aws.amazon.com/amazondynamodb/latest/developerguide/WorkingWithTables.html"
 ...
 * <li>
 * <p>
 * <i>GetItem</i> - Returns a set of attributes for the item that has a given primary key. By
 * default, <i>GetItem</i> performs an eventually consistent read; however, applications can request
 * a strongly consistent read instead.
 * </p>
 * </li>
 * <li>
 * <p>
 * <i>BatchGetItem</i> - Performs multiple <i>GetItem</i> requests for data items using their
 * primary keys, from one table or multiple tables. The response from <i>BatchGetItem</i> has a size
 * limit of 16 MB and returns a maximum of 100 items. Both eventually consistent and strongly
 * consistent reads can be used.
 * </p>
 * </li>
 * <li>
 * <p>
 * <i>Query</i> - Returns one or more items from a table or a secondary index. You must provide a
 * specific value for the partition key. You can narrow the scope of the query using comparison
 * operators against a sort key value, or on the index key. <i>Query</i> supports either eventual or
 * strong consistency. A single response has a size limit of 1 MB.
 * </p>
 * </li>
 * <li>
 * <p>
 * <i>Scan</i> - Reads every item in a table; the result set is eventually consistent. You can limit
 * the number of items returned by filtering the data attributes, using conditional expressions.
 * <i>Scan</i> can be used to enable ad-hoc querying of a table against non-key attributes; however,
 * since this is a full table scan without using an index, <i>Scan</i> should not be used for any
 * application query use case that requires predictable performance.
 * </p>
 * </li>
 * </ul>
 * <p>
 * For conceptual information about reading data, see
 * <a href= "http://docs.aws.amazon.com/amazondynamodb/latest/developerguide/WorkingWithItems.html"
 * >Working with Items</a> and
 * <a href= "http://docs.aws.amazon.com/amazondynamodb/latest/developerguide/QueryAndScan.html" >
 ...
 * <li>
 * <p>
 * <i>PutItem</i> - Creates a new item, or replaces an existing item with a new item (including all
 * the attributes). By default, if an item in the table already exists with the same primary key,
 * the new item completely replaces the existing item. You can use conditional operators to replace
 * an item only if its attribute values match certain conditions, or to insert a new item only if
 * that item doesn't already exist.
 * </p>
 * </li>
 * <li>
 * <p>
 * <i>UpdateItem</i> - Modifies the attributes of an existing item. You can also use conditional
 * operators to perform an update only if the item's attribute values match certain conditions.
 * </p>
 * </li>
 * <li>
 * <p>
 * <i>DeleteItem</i> - Deletes an item in a table by primary key. You can use conditional operators
 * to perform a delete an item only if the item's attribute values match certain conditions.
 * </p>
 * </li>
 * <li>
 * <p>
 * <i>BatchWriteItem</i> - Performs multiple <i>PutItem</i> and <i>DeleteItem</i> requests across
 * multiple tables in a single request. A failure of any request(s) in the batch will not cause the
 * entire <i>BatchWriteItem</i> operation to fail. Supports batches of up to 25 items to put or
...
public class AmazonDynamoDBClient extends AmazonWebserviceClient implements AmazonDynamoDB {
    ...
    static {
        AwsSdkMetrics.addAll(Arrays.asList(
                        com.amazonaws.services.dynamodbv2.metrics.DynamoDBRequestMetric.values()));
    }
    ...
    protected static final AmazonDynamoDBClientConfigurationFactory configFactory =
                    new AmazonDynamoDBClientConfigurationFactory();

    private final SdkJsonProtocolFactory protocolFactory = new SdkJsonProtocolFactory(
                    new JsonClientMetadata().withProtocolVersion("1.0").withSupportsCbor(false)
                                    .addErrorMetadata(new JsonErrorShapeMetadata()
                                                    .withErrorCode("ResourceInUseException").withModeledClass(
    ...
    /**
     * Constructs a new client to invoke service methods on DynamoDB. A credentials provider chain
     ...
     *
     * <p>
     * All service calls made using this new client object are blocking, and will not return until
     ...
     *            The client configuration options controlling how this client connects to DynamoDB
    ...
    /**
     * Constructs a new client to invoke service methods on DynamoDB using the specified AWS account
     * credentials.
     *
     * <p>
     * All service calls made using this new client object are blocking, and will not return until
     ...
     *            The AWS credentials (access key ID and secret key) to use when authenticating with
     *            AWS services.
     */
     ...
     *            The AWS credentials provider which will provide credentials to authenticate
     *            requests with AWS services.
     */
    ...
    /**
     * <p>
     * The <i>BatchGetItem</i> operation returns the attributes of one or more items from one or
     ...
     * appropriate <i>UnprocessedKeys</i> value so you can get the next page of results. If desired,
     * your application can include its own logic to assemble the pages of results into one data
     * set.
     * </p>
     * <p>
     * If <i>none</i> of the items can be processed due to insufficient provisioned throughput on
     * all of the tables in the request, then <i>BatchGetItem</i> will return a
     ...
     * keys of the unread items in <i>UnprocessedKeys</i>.
     * </p>
     * <important>
     * <p>
     ...
     * </important>
     * <p>
     * By default, <i>BatchGetItem</i> performs eventually consistent reads on every table in the
     ...
     * items in your request in the <i>AttributesToGet</i> parameter.
     * </p>
     * <p>
     ...
     *             and use exponential backoff. For more information, go to <a href=
     *             "http://docs.aws.amazon.com/amazondynamodb/latest/developerguide/ErrorHandling.html#APIRetries"
     *             >Error Retries and Exponential Backoff</a> in the <i>Amazon DynamoDB Developer
     *             Guide</i>.
     * @throws com.amazonaws.services.dynamodbv2.model.ResourceNotFoundException
     *             The operation tried to access a nonexistent table or index. The resource might
     *             not be specified correctly, or its status might not be <code>ACTIVE</code>.
     * @throws com.amazonaws.services.dynamodbv2.model.InternalServerErrorException
    ...
    public Future<BatchGetItemResult> batchGetItem(BatchGetItemRequest batchGetItemRequest) {
        ...
        try {
            ...
            HttpResponseHandler<AmazonWebServiceResponse<BatchGetItemResult>> responseHandler =
    ...
    @Override
    public Future<BatchGetItemResult> batchGetItem(Map<String, KeysAndAttributes> requestItems,
    ...
    /**
     * <p>
     * The <i>BatchWriteItem</i> operation puts or deletes multiple items in one or more tables. A
     * single call to <i>BatchWriteItem</i> can write up to 16 MB of data, which can comprise as
     * many as 25 put or delete requests. Individual items to be written can be as large as 400 KB.
     * </p>
     * <note>
     * <p>
     ...
     * throughput on all of the tables in the request, then <i>BatchWriteItem</i> will return a
     ...
     * </important>
     * <p>
     * With <i>BatchWriteItem</i>, you can efficiently write or delete large amounts of data, such
     * as from Amazon Elastic MapReduce (EMR), or copy data from another database into DynamoDB. In
     * order to improve performance with these large-scale operations, <i>BatchWriteItem</i> does
     * not behave in the same way as individual <i>PutItem</i> and <i>DeleteItem</i> calls would.
     * For example, you cannot specify conditions on individual put and delete requests, and
     ...
     * one at a time. In both situations, <i>BatchWriteItem</i> provides an alternative where the
     * API performs the specified put and delete operations in parallel, giving you the power of the
     * thread pool approach without having to introduce complexity into your application.
     * </p>
     * <p>
     ...
     *             The operation tried to access a nonexistent table or index. The resource might
     *             not be specified correctly, or its status might not be <code>ACTIVE</code>.
     * @throws com.amazonaws.services.dynamodbv2.model.ItemCollectionSizeLimitExceededException
     ...
     */
    @Override
    public Future<BatchWriteItemResult> batchWriteItem(
        ...
        try {
            ...
            try {
                request = new BatchWriteItemRequestMarshaller(protocolFactory)
                                .marshall(super.beforeMarshalling(batchWriteItemRequest));
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
            ...
            HttpResponseHandler<AmazonWebServiceResponse<BatchWriteItemResult>> responseHandler =
                            protocolFactory.createResponseHandler(
                                            new JsonOperationMetadata().withPayloadJson(true)
                                                            .withHasStreamingSuccessResponse(false),
    ...
    /**
     * <p>
     * The <i>CreateTable</i> operation adds a new table to your account. In an AWS account, table
     ...
     * </p>
     * <p>
     * <i>CreateTable</i> is an asynchronous operation. Upon receiving a <i>CreateTable</i> request,
     * DynamoDB immediately returns a response with a <i>TableStatus</i> of <code>CREATING</code>.
     * After the table is created, DynamoDB sets the <i>TableStatus</i> to <code>ACTIVE</code>. You
     * can perform read and write operations only on an <code>ACTIVE</code> table.
     * </p>
     * <p>
     * You can optionally define secondary indexes on the new table, as part of the
     * <i>CreateTable</i> operation. If you want to create multiple tables with secondary indexes on
     * them, you must create the tables sequentially. Only one table with secondary indexes can be
     ...
     * @throws com.amazonaws.services.dynamodbv2.model.ResourceInUseException
     *             The operation conflicts with the resource's availability. For example, you
     *             attempted to recreate an existing table, or tried to delete a table currently in
     *             the <code>CREATING</code> state.
     ...
     *             </p>
     *             <p>
     *             Also, for tables with secondary indexes, only one of those tables can be in the
    ...
    public Future<CreateTableResult> createTable(CreateTableRequest createTableRequest) {
        ...
        try {
            ...
            HttpResponseHandler<AmazonWebServiceResponse<CreateTableResult>> responseHandler =
                            protocolFactory.createResponseHandler(
                                            new JsonOperationMetadata().withPayloadJson(true)
                                                            .withHasStreamingSuccessResponse(false),
    ...
    @Override
    public Future<CreateTableResult> createTable(List<AttributeDefinition> attributeDefinitions,
                    String tableName, List<KeySchemaElement> keySchema,
                    ProvisionedThroughput provisionedThroughput) {
        return createTable(new CreateTableRequest().withAttributeDefinitions(attributeDefinitions)
     ...
     * </p>
     * <p>
     * Unless you specify conditions, the <i>DeleteItem</i> is an idempotent operation; running it
     * multiple times on the same item or attribute does <i>not</i> result in an error response.
     * </p>
     * <p>
    ...
    public Future<DeleteItemResult> deleteItem(DeleteItemRequest deleteItemRequest) {
        ...
        try {
            ...
            HttpResponseHandler<AmazonWebServiceResponse<DeleteItemResult>> responseHandler =
                            protocolFactory.createResponseHandler(
                                            new JsonOperationMetadata().withPayloadJson(true)
                                                            .withHasStreamingSuccessResponse(false),
    ...
    @Override
    public Future<DeleteItemResult> deleteItem(String tableName, Map<String, AttributeValue> key) {
     ...
     * DynamoDB completes the deletion. If the table is in the <code>ACTIVE</code> state, you can
     * delete it. If a table is in <code>CREATING</code> or <code>UPDATING</code> states, then
     * DynamoDB returns a <i>ResourceInUseException</i>. If the specified table does not exist,
     * DynamoDB returns a <i>ResourceNotFoundException</i>. If table is already in the
     * <code>DELETING</code> state, no error is returned.
     * </p>
     * <note>
     * <p>
     * DynamoDB might continue to accept data read and write operations, such as <i>GetItem</i> and
     ...
     * table goes into the <code>DISABLED</code> state, and the stream is automatically deleted
     * after 24 hours.
     * </p>
     * <p>
    ...
    public Future<DeleteTableResult> deleteTable(DeleteTableRequest deleteTableRequest) {
        ...
        try {
            ...
            HttpResponseHandler<AmazonWebServiceResponse<DeleteTableResult>> responseHandler =
                            protocolFactory.createResponseHandler(
                                            new JsonOperationMetadata().withPayloadJson(true)
                                                            .withHasStreamingSuccessResponse(false),
    ...
    @Override
    public Future<DeleteTableResult> deleteTable(String tableName) {
        return deleteTable(new DeleteTableRequest().withTableName(tableName));
    }

    /**
     * <p>
     * Returns the current provisioned-capacity limits for your AWS account in a region, both for
     * the region as a whole and for any one DynamoDB table that you create there.
     * </p>
     * <p>
     * When you establish an AWS account, the account has initial limits on the maximum read
     * capacity units and write capacity units that you can provision across all of your DynamoDB
     * tables in a given region. Also, there are per-table limits that apply when you create a table
     * there. For more information, see
     * <a href= "http://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Limits.html" >
     * Limits</a> page in the <i>Amazon DynamoDB Developer Guide</i>.
     * </p>
     * <p>
     * Although you can increase these limits by filing a case at
     * <a href="https://console.aws.amazon.com/support/home#/">AWS Support Center</a>, obtaining the
     * increase is not instantaneous. The <i>DescribeLimits</i> API lets you write code to compare
     * the capacity you are currently using to those limits imposed by your account so that you have
     * enough time to apply for an increase before you hit a limit.
     * </p>
     * <p>
     ...
     * <li>
     * <p>
     * Call <i>DescribeLimits</i> for a particular region to obtain your current account limits on
     ...
     * in that region, and one to hold the aggregate write capacity units. Zero them both.
     * </p>
     * </li>
     * <li>
     * <p>
     ...
     * <li>
     * <p>
     * Report the account limits for that region returned by <i>DescribeLimits</i>, along with the
     ...
     * </p>
     * <p>
     * The per-table limits apply only when you are creating a new table. They restrict the sum of
     * the provisioned capacity of the new table itself and all its global secondary indexes.
     * </p>
     * <p>
     * For existing tables and their GSIs, DynamoDB will not let you increase provisioned capacity
     * extremely rapidly, but the only upper limit that applies is that the aggregate provisioned
     * capacity over all your tables and GSIs cannot exceed either of the per-account limits.
     * </p>
     * <note>
     * <p>
     * <i>DescribeLimits</i> should only be called periodically. You can expect throttling errors if
     ...
     */
    @Override
    public Future<DescribeLimitsResult> describeLimits(
        ...
        try {
            ...
            HttpResponseHandler<AmazonWebServiceResponse<DescribeLimitsResult>> responseHandler =
                            protocolFactory.createResponseHandler(
                                            new JsonOperationMetadata().withPayloadJson(true)
                                                            .withHasStreamingSuccessResponse(false),
     ...
     * <note>
     * <p>
     * If you issue a <i>DescribeTable</i> request immediately after a <i>CreateTable</i> request,
     * DynamoDB might return a <i>ResourceNotFoundException</i>. This is because
     * <i>DescribeTable</i> uses an eventually consistent query, and the metadata for your table
    ...
    public Future<DescribeTableResult> describeTable(DescribeTableRequest describeTableRequest) {
        ...
        try {
            ...
            HttpResponseHandler<AmazonWebServiceResponse<DescribeTableResult>> responseHandler =
                            protocolFactory.createResponseHandler(
                                            new JsonOperationMetadata().withPayloadJson(true)
                                                            .withHasStreamingSuccessResponse(false),
    ...
    @Override
    public Future<DescribeTableResult> describeTable(String tableName) {
        return describeTable(new DescribeTableRequest().withTableName(tableName));
    }

    /**
     * <p>
     * The <i>GetItem</i> operation returns a set of attributes for the item with the given primary
     * key. If there is no matching item, <i>GetItem</i> does not return any data.
     * </p>
     * <p>
    ...
    public Future<GetItemResult> getItem(GetItemRequest getItemRequest) {
        return getItem(getItemRequest, null);
    }

    @Override
    public Future<GetItemResult> getItem(GetItemRequest getItemRequest,
                    ResultHandler<GetItemResult> asyncHandler) {
        ...
        try {
            ...
            HttpResponseHandler<AmazonWebServiceResponse<GetItemResult>> responseHandler =
                            protocolFactory.createResponseHandler(
                                            new JsonOperationMetadata().withPayloadJson(true)
                                                            .withHasStreamingSuccessResponse(false),
                                            new GetItemResultJsonUnmarshaller());

            return invoke(request, responseHandler, executionContext, asyncHandler);
    ...
    @Override
    public Future<GetItemResult> getItem(String tableName, Map<String, AttributeValue> key) {
     ...
     * from <i>ListTables</i> is paginated, with each page returning a maximum of 100 table names.
     * </p>
     *
    ...
    public Future<ListTablesResult> listTables(ListTablesRequest listTablesRequest) {
        ...
        try {
            ...
            HttpResponseHandler<AmazonWebServiceResponse<ListTablesResult>> responseHandler =
                            protocolFactory.createResponseHandler(
                                            new JsonOperationMetadata().withPayloadJson(true)
                                                            .withHasStreamingSuccessResponse(false),
    ...
    @Override
    public Future<ListTablesResult> listTables(String exclusiveStartTableName) {
        return listTables(new ListTablesRequest()
                        .withExclusiveStartTableName(exclusiveStartTableName));
    }

    @Override
    public Future<ListTablesResult> listTables(String exclusiveStartTableName, Integer limit) {
        return listTables(new ListTablesRequest()
                        .withExclusiveStartTableName(exclusiveStartTableName).withLimit(limit));
    }

    @Override
    public Future<ListTablesResult> listTables(Integer limit) {
     ...
     * with a <i>ValidationException</i> exception.
     * </p>
     * <p>
     * You can request that <i>PutItem</i> return either a copy of the original item (before the
     * update) or a copy of the updated item (after the update). For more information, see the
     * <i>ReturnValues</i> description below.
     * </p>
     * <note>
     * <p>
     * To prevent a new item from replacing an existing item, use a conditional expression that
     * contains the <code>attribute_not_exists</code> function with the name of the attribute being
     * used as the partition key for the table. Since every record must contain that attribute, the
     * <code>attribute_not_exists</code> function will only succeed if no matching item exists.
     * </p>
     * </note>
     * <p>
    ...
    public Future<PutItemResult> putItem(PutItemRequest putItemRequest) {
        ...
        try {
            ...
            HttpResponseHandler<AmazonWebServiceResponse<PutItemResult>> responseHandler =
                            protocolFactory.createResponseHandler(
                                            new JsonOperationMetadata().withPayloadJson(true)
                                                            .withHasStreamingSuccessResponse(false),
    ...
    @Override
    public Future<PutItemResult> putItem(String tableName, Map<String, AttributeValue> item) {
     ...
     * </p>
     * <p>
     * Use the <i>KeyConditionExpression</i> parameter to provide a specific value for the partition
     * key. The <i>Query</i> operation will return all of the items from the table or index with
     * that partition key value. You can optionally narrow the scope of the <i>Query</i> operation
     * by specifying a sort key value and a comparison operator in <i>KeyConditionExpression</i>.
     * You can use the <i>ScanIndexForward</i> parameter to get results in forward or reverse order,
     * by sort key.
     * </p>
     * <p>
     * Queries that do not return results consume the minimum number of read capacity units for that
     * type of read operation.
     * </p>
     * <p>
     * If the total number of items meeting the query criteria exceeds the result set size limit of
     * 1 MB, the query stops and results are returned to the user with the <i>LastEvaluatedKey</i>
     * element to continue the query in a subsequent operation. Unlike a <i>Scan</i> operation, a
     * <i>Query</i> operation never returns both an empty result set and a <i>LastEvaluatedKey</i>
     * value. <i>LastEvaluatedKey</i> is only provided if you have used the <i>Limit</i> parameter,
     ...
     * table or on a local secondary index, you can set the <i>ConsistentRead</i> parameter to
     * <code>true</code> and obtain a strongly consistent result. Global secondary indexes support
    ...
    public Future<QueryResult> query(QueryRequest queryRequest) {
        ...
        try {
            ...
            HttpResponseHandler<AmazonWebServiceResponse<QueryResult>> responseHandler =
                            protocolFactory.createResponseHandler(
                                            new JsonOperationMetadata().withPayloadJson(true)
                                                            .withHasStreamingSuccessResponse(false),
    ...
    /**
     * <p>
     * The <i>Scan</i> operation returns one or more items and item attributes by accessing every
     * item in a table or a secondary index. To have DynamoDB return fewer items, you can provide a
     * <i>ScanFilter</i> operation.
     * </p>
     * <p>
     * If the total number of scanned items exceeds the maximum data set size limit of 1 MB, the
     * scan stops and results are returned to the user as a <i>LastEvaluatedKey</i> value to
     ...
     * </p>
     * <p>
     * By default, <i>Scan</i> operations proceed sequentially; however, for faster performance on a
     * large table or secondary index, applications can request a parallel <i>Scan</i> operation by
     * providing the <i>Segment</i> and <i>TotalSegments</i> parameters. For more information, see
     * <a href=
     ...
     * </p>
     * <p>
     * By default, <i>Scan</i> uses eventually consistent reads when accessing the data in a table;
     * therefore, the result set might not include the changes to data in the table immediately
     * before the operation began. If you need a consistent copy of the data, as of the time that
     * the Scan begins, you can set the <i>ConsistentRead</i> parameter to <i>true</i>.
     * </p>
     *
     * @param scanRequest
    ...
    public Future<ScanResult> scan(ScanRequest scanRequest) {
        ...
        try {
            ...
            HttpResponseHandler<AmazonWebServiceResponse<ScanResult>> responseHandler =
                            protocolFactory.createResponseHandler(
                                            new JsonOperationMetadata().withPayloadJson(true)
                                                            .withHasStreamingSuccessResponse(false),
    ...
    @Override
    public Future<ScanResult> scan(String tableName, List<String> attributesToGet) {
        return scan(new ScanRequest().withTableName(tableName)
                        .withAttributesToGet(attributesToGet));
    }

    @Override
    public Future<ScanResult> scan(String tableName, Map<String, Condition> scanFilter) {
     ...
     * </p>
     * <p>
     * You can also return the item's attribute values in the same <i>UpdateItem</i> operation using
     * the <i>ReturnValues</i> parameter.
     * </p>
     *
    ...
    public Future<UpdateItemResult> updateItem(UpdateItemRequest updateItemRequest) {
        ...
        try {
            ...
            HttpResponseHandler<AmazonWebServiceResponse<UpdateItemResult>> responseHandler =
                            protocolFactory.createResponseHandler(
                                            new JsonOperationMetadata().withPayloadJson(true)
                                                            .withHasStreamingSuccessResponse(false),
    ...
    @Override
    public Future<UpdateItemResult> updateItem(String tableName, Map<String, AttributeValue> key,
    ...
    public Future<UpdateItemResult> updateItem(String tableName, Map<String, AttributeValue> key,
        ...
        return updateItem(new UpdateItemRequest().withTableName(tableName).withKey(key)
                        .withAttributeUpdates(attributeUpdates).withReturnValues(returnValues));
    }
     ...
     * use <i>UpdateTable</i> to perform other operations.
     * </p>
     * </li>
     * </ul>
     * <p>
     * <i>UpdateTable</i> is an asynchronous operation; while it is executing, the table status
    ...
    public Future<UpdateTableResult> updateTable(UpdateTableRequest updateTableRequest) {
        ...
        try {
            ...
            HttpResponseHandler<AmazonWebServiceResponse<UpdateTableResult>> responseHandler =
                            protocolFactory.createResponseHandler(
                                            new JsonOperationMetadata().withPayloadJson(true)
                                                            .withHasStreamingSuccessResponse(false),
    ...
    @Override
    public Future<UpdateTableResult> updateTable(String tableName,
                    ProvisionedThroughput provisionedThroughput) {
     ...
     * interface.
     * <p>
     * Response metadata is only cached for a limited period of time, so if you need to access this
     * extra diagnostic information for an executed request, you should use this method to retrieve
     * it as soon as possible after executing the request.
     *
     * @param request
     ...
     * request level.
     **/
    private <X> Future<X> invoke(Request<?> request,
                    HttpResponseHandler<AmazonWebServiceResponse<X>> responseHandler,
                    ExecutionContext executionContext, ResultHandler<X> asyncHandler) {
        ...
        return doInvoke(request, responseHandler, executionContext, asyncHandler);
    }
     ...
     **/
    private <X> Future<X> doInvoke(Request<?> request,
                    HttpResponseHandler<AmazonWebServiceResponse<X>> responseHandler,
                    ExecutionContext executionContext, ResultHandler<X> asyncHandler) {
        ...
        return client.execute(request, responseHandler, executionContext, asyncHandler);
    }

 ...
 * Created by amiroshn
 *
 * Factory producing predefined {@link ClientConfiguration} instances for the AmazonDynamoDB client.
 */
@SdkInternalApi
public class AmazonDynamoDBClientConfigurationFactory extends ClientConfigurationFactory {
